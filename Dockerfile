...
RUN curl -L https://cdn.porter.sh/plugins/azure/${AZURE_PLUGIN_VERSION}/azure-linux-amd64 -o /tmp/azure
...
COPY --chown=65535:0 --chmod=770 --from=builder /tmp/azure /app/.porter/plugins/azure/azure
